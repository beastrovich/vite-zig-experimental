// import blobUrl from "./blob.wasm?url";
...
// // const blobUrl = new URL("./blob.wasm", import.meta.url).href;
...
//   allocImageBuffer(width: number, height: number): number;
// };
...
//   const instSource = await WebAssembly.instantiateStreaming(fetch(blobUrl), {
//     env: {
//       memory,
//     },
//     ...imports({ memory }),
